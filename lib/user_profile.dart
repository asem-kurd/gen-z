  ...
  Future<void> fetchUserData() async {
    try {
      ...
      if (currentUser != null) {
        ...
        if (userDoc.exists) {
          gender.value = userDoc['gender'] ?? "Male";
        } else {
          print("No user is currently logged in.");
        }
      }
  ...
  Future<void> fetchEventsData() async {
    try {
      ...
      if (currentUser != null) {
        ...
        events.value = eventDocs.docs.map((doc) {
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String avatar_path = controller.gender.value == "Male"
        ? 'assets/images/avatar/male.jpeg'
        ...
        children: [
          Column(
            ...
            children: [
              CircleAvatar(
                radius: 50,
                backgroundImage: AssetImage(avatar_path),
              ),
